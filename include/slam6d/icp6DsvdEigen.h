 ...
 *  @authot Thomas Wiemann. Institute of Computer Science, University of Osnabrueck, Germany.
 */

#ifndef __ICP6DSVDEIGEN_H__
#define __ICP6DSVDEIGEN_H__
 ...
 */
class icp6D_SVD_Eigen : public icp6Dminimizer
{
public:
  /** 
   * Constructor 
   */
  icp6D_SVD_Eigen(bool quiet = false) : icp6Dminimizer(quiet) {};
  /** 
   * Destructor 
   */
  virtual ~icp6D_SVD_Eigen() {};                                
