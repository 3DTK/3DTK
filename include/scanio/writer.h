...
void write_uos(DataXYZ &xyz, FILE *file, double scaleFac = 1.0, bool hexfloat = false, bool high_precision=false);
void write_uosr(DataXYZ &xyz, DataReflectance &xyz_reflectance, FILE *file, double scaleFac = 1.0, bool hexfloat = false,bool high_precision=false);
void write_uos_rgb(DataXYZ &xyz, DataRGB &rgb, FILE *file, double scaleFac = 1.0, bool hexfloat = false, bool high_precision=false);
