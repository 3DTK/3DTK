...
IMPORTANT;
For detecting planes compile slam6D with the WITH_SHAPE_DETECTION option.
Adapt the settings in bin/hough.cfg for your data set.

Extremely large scans or scans with large differences in point distribution
might need to be reduced before registration. 
