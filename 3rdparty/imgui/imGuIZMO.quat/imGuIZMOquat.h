...
//        and GLM_ENABLE_EXPERIMENTAL compile option to enable "vgm::Quaternion" class
...
struct imguiGizmo
{
    ...
    vgm::Quat qtV  = vgm::Quat(1.0f, vgm::Vec3(0.0f)); // vgm::Quaternion value
    vgm::Quat qtV2 = vgm::Quat(1.0f, vgm::Vec3(0.0f)); // vgm::Quaternion value
