...
int main(int argc, char** argv){
  ...
  imwrite(info.outDir+"feature"+to_string(info.start, 3)+".jpg", outImage);
  outImage.release();
  ...
  imwrite(info.outDir+"feature"+to_string(info.end, 3)+".jpg", outImage);
  outImage.release();
  ...
  imwrite(info.outDir+"match"+to_string(info.start, 3)+"_"+to_string(info.end, 3)+".jpg", outImage);
  outImage.release();
}
