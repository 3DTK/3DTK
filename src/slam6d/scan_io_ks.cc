 ...
 */
int ScanIO_ks::readScans(int start, int end, string &dir, int maxDist, int mindist,
			  double *euler, vector<Point> &ptss)
{
  ...
  scanFileName = dir + "ks" + to_string(fileCounter,3) + ".txt";
