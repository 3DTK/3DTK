...
void icp6D_QUAT_SCALE::quaternion2matrix(double *q, double m[3][3])
{
  double q00 = q[0]*q[0];
  double q11 = q[1]*q[1];
  double q22 = q[2]*q[2];
...
int icp6D_QUAT_SCALE::ferrari(double a, double b, double c, double d,	double rts[4])
/* 
...
int icp6D_QUAT_SCALE::qudrtc(double b, double c, double rts[4])
/* 
...
double icp6D_QUAT_SCALE::cubic(double p, double q, double r)
/* 
...
void icp6D_QUAT_SCALE::maxEigenVector(double Q[4][4], double ev[4])
{
  double N[4][4];
  double rts[4];
  double c[4];
...
void icp6D_QUAT_SCALE::characteristicPol(double Q[4][4], double c[4])
{
  // squares
