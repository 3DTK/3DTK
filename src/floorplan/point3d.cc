...
floorplan::Point3d::Point3d() {
    this->x = 0.0;
    this->y = 0.0;
    this->z = 0.0;
}

floorplan::Point3d::Point3d(const double& x, const double& y, const double& z) {
    this->x = x;
    this->y = y;
    this->z = z;
}

floorplan::Point3d::Point3d(const Point3d& other) {
    this->x = other.x;
    this->y = other.y;
    this->z = other.z;
}
...
void floorplan::Point3d::rotate(const Point3d& ref, const Rotation3d& rot)
{
...
void floorplan::Point3d::translate(const Vector3d& vec) {
    this->x += vec.x;
    this->y += vec.y;
    this->z += vec.z;
}
...
double floorplan::Point3d::distance(const Point3d& other) const {
...
double floorplan::Point3d::distance(const Plane3d& plane) const {
    double vect[3];
...
floorplan::Point3d& floorplan::Point3d::operator=(const Point3d& other) {
    if (this != &other) {
        this->x = other.x;
        this->y = other.y;
        this->z = other.z;
...
floorplan::Point3d floorplan::Point3d::operator*(const double& coef) {
    Point3d result;
    result = *this;
    result.x *= coef;
    result.y *= coef;
...
floorplan::Point3d floorplan::Point3d::operator/(const double& div) {
    Point3d result;
    result.x = this->x / div;
    result.y = this->y / div;
    result.z = this->z / div;
...
void floorplan::Point3d::operator/=(const double& div) {
    this->x /= div;
    this->y /= div;
    this->z /= div;
}

void floorplan::Point3d::operator+=(const Point3d& other) {
    this->x += other.x;
    this->y += other.y;
    this->z += other.z;
}
...
void floorplan::Point3d::operator*=(const double& coef) {
    this->x *= coef;
    this->y *= coef;
    this->z *= coef;
}
...
bool floorplan::Point3d::operator==(const Point3d& other) const {
...
bool floorplan::Point3d::operator!=(const Point3d& other) {
    if (*this == other) {
        return false;
    }
    return true;
...
std::ostream& floorplan::operator<<(std::ostream& os, const floorplan::Point3d& pt) {
    os << pt.x << " " << pt.y << " " << pt.z;
    return os;
}
