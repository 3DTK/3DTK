...
floorplan::Vector3d::Vector3d() {
    // nothing to do
}

floorplan::Vector3d::Vector3d(const double& x, const double& y, const double& z) {
    this->x = x;
    this->y = y;
    this->z = z;
}
...
floorplan::Vector3d::Vector3d(const Point3d& a, const Point3d& b) {
    this->x = b.x - a.x;
    this->y = b.y - a.y;
    this->z = b.z - a.z;
}

floorplan::Vector3d::Vector3d(const Vector3d& other) {
    this->x = other.x;
    this->y = other.y;
    this->z = other.z;
}

floorplan::Vector3d& floorplan::Vector3d::operator=(const floorplan::Vector3d& other) {
    if (this != &other) {
        this->x = other.x;
        this->y = other.y;
        this->z = other.z;
...
void floorplan::Vector3d::normalize() {
    // squares
...
// inverses the vector
void floorplan::Vector3d::invert() {
    this->x *= (-1);
    this->y *= (-1);
    this->z *= (-1);
}
...
floorplan::Vector3d floorplan::Vector3d::crossProduct(const Vector3d& other) const {
    Vector3d ret;
...
double floorplan::Vector3d::dotProduct(const Vector3d& other) const {
...
double floorplan::Vector3d::angle(const Vector3d& other) {
...
void floorplan::Vector3d::operator+=(const Vector3d& other) {
    this->x += other.x;
    this->y += other.y;
    this->z += other.z;
}

floorplan::Vector3d floorplan::Vector3d::operator+(const Vector3d& other) {
    Vector3d result;
...
floorplan::Vector3d floorplan::Vector3d::operator*(const double& val) {
    Vector3d result;
...
void floorplan::Vector3d::operator/=(const double& div) {
    this->x /= div;
    this->y /= div;
    this->z /= div;
}
...
std::ostream& floorplan::operator<<(std::ostream& os, const floorplan::Vector3d& vect) {
